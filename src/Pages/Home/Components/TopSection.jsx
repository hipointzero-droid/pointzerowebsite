...
export default function TopSection() {
  ...
  return (
    <section className=' bg-black lg:px-20 px-5 lg:pt-14 pt-5 pb-3 flex justify-between'>
        ...
        <button className=' border-blue-500 border-2 bg-black py-2 font-semibold  px-7 mt-10'
        onClick={()=>{
          navigate("/contact")
        }}
        >CONTACT US</button>
